...
public class CannonBallFactory : System.Object {
    ...
    public void wipeFactory()
    {
        ...
        usingMelonBallList.Clear();
        unusedMelonBallList.Clear();

        usingPizzaBallList.Clear();
        unusedPizzaBallList.Clear();

        usingIceBallList.Clear();
        unusedIceBallList.Clear();

        usingDrinkBallList.Clear();
        unusedDrinkBallList.Clear();
